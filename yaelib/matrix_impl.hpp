...
template<class T>
inline void vector3<T>::copy(T* dest)
{
    dest[0] = v[0];
    dest[1] = v[1];
    dest[2] = v[2];
...
template<class T>
inline vector4<T>::vector4(const vector3<T> vec3, T w)
{
    v[0] = vec3.v[0];
    v[1] = vec3.v[1];
    v[2] = vec3.v[2];
...
template<class T>
inline T color4<T>::r() const
{
    return this->v[0];
}

template<class T>
inline T color4<T>::g() const
{
    return this->v[1];
}

template<class T>
inline T color4<T>::b() const
{
    return this->v[2];
}

template<class T>
inline T color4<T>::a() const
{
    return this->v[3];
}
